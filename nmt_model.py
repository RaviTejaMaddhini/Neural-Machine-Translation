...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        enc_input=pack_padded_sequence(input=X,lengths=source_lengths,batch_first=False)
        enc_output,(hn,cn)=self.encoder(enc_input)

        # hidden_states=pad_packed_sequence(hn)
        enc_output=pad_packed_sequence(enc_output)
        enc_hiddens=enc_output[0]
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in torch.split(Y,1,0):
            ...
            dec_state,o_t,dummy=self.step(Ybar_t=Ybar_t,dec_state= dec_state,
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        hx,cx=self.decoder(Ybar_t,dec_state)
        ...
        alpha_t=torch.squeeze(alpha_t,1)
